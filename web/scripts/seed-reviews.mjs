...
const CH_GAIN = ["촉촉해","수분감 꽉 차","수분 차오르는 느낌이야","물광 올라옴","수분감 살아남","속부터 촉촉해짐","하루종일 촉촉해","수분 폭발","당김 1도 없어","수분감 미쳤어","촉촉함 유지됨","피부 안 당겨서 좋아"];
const C_TONE = ["톤 올라온 게 보여","칙칙함이 가심","안색 밝아짐","한 톤 맑아진 느낌이야","화사해졌다는 말 들음","잡티 옅어진 거 보임","피부 환해짐","어두웠는데 톤 살아남","생기 도는 느낌이야"];
const C_ELAS = ["탱탱함이 살아남","처짐이 덜해졌어","탄력 생긴 느낌이야","볼이 좀 올라온 듯","피부가 단단해진 느낌","처짐 잡힌 느낌이야"];
const C_TEX = ["결 진짜 매끈해졌어","각질 덜 일어나","피부 부드러워졌어","결 정돈된 느낌이야","손 자꾸 가ㅎㅎ","오돌토돌하던 게 매끈해짐"];
const C_MISC = ["화장이 안 떠","모공 줄어든 느낌이야","부기 덜해","피부가 좀 사는 느낌이야","화장 잘 먹어","컨디션 안 좋아도 얼굴 안 죽어","트러블 줄었어","화장 지속력 좋아짐","피곤한 티 덜 나"];
function casualRes() {
  const r = Math.random();
