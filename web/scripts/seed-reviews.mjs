...
const RES = [
  ...
  // 수분·촉촉 다양화
  "수분감 올라오네요","눈에 띄게 촉촉해진 느낌이네요","촉촉해졌어요","확실히 덜 건조하고 수분감이 꽉 차요",
  "화장 안 해도 수분감이 있어서 물광 느낌이 나요","속건조가 잡혀 하루 종일 촉촉해요","푸석하던 게 촉촉하게 바뀌었어요",
  "물 먹은 것처럼 속부터 촉촉해요","세안 후 당김이 확 줄었어요","겉은 보송한데 속은 촉촉해요",
  "수분 막이 생긴 듯 촉촉함이 오래가요","아침에 얼굴 당기던 게 없어졌어요","피부가 수분으로 채워지는 느낌이에요",
  // 톤·탄력 다양화
  "한 꺼풀 벗은 듯 맑아졌어요","화사하고 투명한 느낌이 들어요","어둡던 안색이 살아났어요",
  "볼 라인이 탄탄해진 느낌이에요","처지던 게 좀 올라온 것 같아요","탱글탱글해진 느낌이에요",
];
// 마무리
const CLOSE = [
...
const CASUAL = [
  ...
  "속건조 잡혀서 하루종일 촉촉함ㅎㅎ 이게 제일 좋아.",
  "와 진짜 안 당겨. 촉촉함이 오래가더라.",
  "세수하고 안 당기는 거 처음이야. 수분 미쳤음.",
  "화장 안 했는데 물광 난다고 함ㅋㅋ 신기해.",
  "건조해서 각질 일어나던 거 없어짐. 촉촉해ㅎㅎ",
];
// 짧은 한줄평
const SHORT = [
  ...
  "촉촉함 오래가요!","속부터 촉촉해짐.","안 당겨서 좋아요ㅎㅎ","물광 인정.",
];
// 4점용 가벼운 캐주얼
const CASUAL4 = [
